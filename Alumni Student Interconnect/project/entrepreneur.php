...
<html lang="en">
	...
	<body>
		...
		<div class="table">
			<table width="100%">
				<caption><label><div style='text-align:center' /><h3>Guidance for Entrepreneurship</h3></label></caption>
					<form>
                <?php
                    ...
                    $sqlg="SELECT * FROM guidance_section WHERE career= 'entrepreneurships'";
